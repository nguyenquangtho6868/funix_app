  ...
  return (
    <div className="home row">
      ...
      <div className="col-lg-2 home-left sidebar dashboard-header">
        <div className={isNav? "main sidebar-item ipad sidebar-ipad-open" : "main sidebar-item ipad sidebar-ipad-close"}>
          <div className="main-title pt-2 pb-2">
            <Typography variant="h5" gutterBottom className="main-title-text">MAIN</Typography>
          ...
          <Link to={'/home/'} className="main-item-link mb-4" onClick={() => setIsNav(false)}>
            <div className="main-item">
                <AccountCircleIcon/>
                <h6 className="ml-2">Users</h6>
            </div>
          </Link>
          <Link to={'/home/courses'} className="main-item-link" onClick={() => setIsNav(false)}>
            <div className="main-item">
                <MenuBookIcon/>
